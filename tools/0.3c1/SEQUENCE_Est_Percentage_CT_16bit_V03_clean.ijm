...
//
// score added
// dicom read through Bioimage tools
// dicom read: https://web.archive.org/web/20170719175213/http://santec.tudor.lu/project/dicom/download
// different morphology for lungs
// 11.03.2021 healthy lungs percentage substract
// 06.04.2021 support windows suppresion (M)
// 14.4.2021 LUT correction
// 20.4.2021 healthy lungs percentage substract v2
// 23.04.2021 TIFF sequence load (M)
// 27.04.2021 title of image as folder name, actuale date in saved info (M)
// 21.9.2021 widget + multiple file type opener (M)
// 21.9.2021 siemens dicom added (M)
// 19.10.2021 version imprint (M)
// 25.10.2021 Space in folder name correction (M)
// 27.12.2021 Clean version
/////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////

print("\\Clear");
run("Close All");
print("Version: " + ver + ", last edit 27.12.2021");
